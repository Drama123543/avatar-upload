require=(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({"avatar-upload":[function(require,module,exports){
function avatarUpload($, Hammer, options) {
  ...
  // 显示图片
  var $uploadBgId = $(options.uploadBgId)
  ...
  function handleFiles(fn) {
    ...
    //显示图片
    $uploadBgId.css("backgroundImage", "url(\"" + imgObjectURL + "\")");
  ...
  function submit(fn) {
    createImg(function() {
      var base64Data = canvas.toDataURL("image/jpeg", options.imgQuality); // JPEG at 100% quality
      if (Object.prototype.toString.call(fn) === "[object Function]") {
        fn(base64Data);
      }
      // toBlob有兼容性问题
